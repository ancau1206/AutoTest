...
$(document).ready(function(){
    $(".delete").click(function(){
        ...
        if (check) {
        	...
        	$.get('/Assiment/phongban/list/xoa/'+id);
        }
    });
});
</script>
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                <a href="${pageContext.request.contextPath}/logout"><i class="icon_key_alt"></i> <s:message code="home.logout" /></a>
    ...
    <!--main content start-->
     <section id="main-content" style="margin-left: 180px;">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i><s:message code="home.departs.title" /> </h3>
            <ol class="breadcrumb"> 
            </ol>
          </div>
        </div>
      ...
      <c:forEach var="u" items="${departs}">              
                    <tr>
                    <input class="departId" name="departId" value="${u.id}" type="hidden" />
                      <td >${u.codeId}</td>
                      <td class="departName" name="departName">${u.name}</td>
                      <td>
                      <form>
