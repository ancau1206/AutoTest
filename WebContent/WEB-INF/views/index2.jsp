...
$(document).ready(function(){
    $(".delete").click(function(){
    	...
    	var id = $(this).parents().eq(2).find(".id").eq(0).val();
        var check = confirm("Bạn có muốn xóa nhân viên "+name+" này không");
        if (check) {
        	$(this).parents().eq(2).remove();
        	$.get('/Assiment/nhanvien/list/xoa/'+id);
        }
    });
});
</script>
 ...
 <li>
    ...
    <section id="main-content" style="margin-left: 180px;">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i><s:message code="home.staffs.title" /> </h3>
            <ol class="breadcrumb"> 
            </ol>
          </div>
        </div>
...
<div class="row">
        ...
        <div class="panel-body">
                <table class="table bootstrap-datatable countries" id="myTable">
                  <thead>
                    <tr>
                      <th><s:message code="home.staffs.codeid" /></th>
                      <th><s:message code="home.staffs.departs" /></th>
                      <th><s:message code="home.staffs.name" /></th>
                      <th><s:message code="home.staffs.gender" /></th>
                      <th><s:message code="home.staffs.image" /></th>
                      <th><s:message code="home.staffs.phone" /></th>
                      <th><s:message code="home.staffs.notes" /></th>
                  ...
                  <tbody>
                    ...
                    <tr>
                    	<input class="id" name="id" value="${u.id}" type="hidden" />
                    	
                      <td>${u.codeId}</td>
                      <td>${u.departs.name}</td>
                      <td class="name">${u.name}</td>
                      <td>${u.gender ? 'Nam' : 'Nữ'}</td>
                      <td><img alt="Image" width="150px" height="150px" src="${pageContext.request.contextPath}/resources/img/${u.photo}"></td>
                      
                      <td>${u.phone}</td>
                      <td>${u.notes}</td>
                      <td>
	                      <form>
		                     <a href="them"><button type="button"><s:message code="home.staffs.add" /></button></a>
		                     <a href=" sua/${u.id }"><button type="button"><s:message code="home.staffs.update" /></button></a>
		                     <button type="button" class="delete"><s:message code="home.staffs.delete" /></button>
		                     <a href="xem/${u.id }"><button type="button"><s:message code="home.viewdetails" /></button></a>
	              	 		</form>
                      </td>
                    </tr>
                 </c:forEach> 
