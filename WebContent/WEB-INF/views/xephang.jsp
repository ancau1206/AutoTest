...
<script>
        ...
        <ul class="nav pull-right top-menu">
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
              ...
              <li>
                <a href="dangnhap"><i class="icon_key_alt"></i><s:message code="home.logout" /></a>
 ...
 <section id="main-content" style="margin-left: 180px;">
      <section class="wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-laptop"></i><s:message code="home.aad.title.staffs" /> </h3>
            <ol class="breadcrumb"> 
            </ol>
          </div>
        </div>
                ...
                <table class="table bootstrap-datatable countries" id="myTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
	                      <form>
		                     <a href="xephang/them/${records[6]}"><button type="button"><s:message code="home.staffs.add" /></button></a>
	              	 		</form>
                      </td>
                    </tr>
                 </c:forEach> 
